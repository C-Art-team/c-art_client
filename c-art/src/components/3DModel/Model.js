...
import { useFBX } from '@react-three/drei/core/useFBX'
...
export default function Model(props){
    ...
    const [asset, setAsset] = useState("https://storage.googleapis.com/storage-c-art.appspot.com/c-art%2F11805_airplane_v2_L2185908bfcd8.obj")
    const format = asset.slice(asset.length-3)

    let model = useLoader(format === "obj"? OBJLoader:
