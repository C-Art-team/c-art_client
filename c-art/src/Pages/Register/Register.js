        ...
        <section className="min-h-screen flex items-stretch text-white">
            <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center">
                <div className="absolute bg-black opacity-60 inset-0 z-0">
                    <img className='h-screen w-full' src='https://m.media-amazon.com/images/M/MV5BODcwNWE3OTMtMDc3MS00NDFjLWE1OTAtNDU3NjgxODMxY2UyXkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_.jpg' />
                </div>
            ...
            <div className="lg:w-1/2 w-full flex flex-col items-center justify-center text-center md:px-16 px-0 z-0 bg-gray-800" >
                ...
                <div className="w-full py-6 z-20">
                    ...
                    <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        ...
                        <div className="pb-2 pt-4">
                            <input className="block w-full p-4 text-lg rounded-xl bg-black" type="text" name="password" id="password" placeholder="Address" />
                        </div>
                        <div className="pb-2 pt-4">
