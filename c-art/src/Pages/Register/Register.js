        ...
        <div className="lg:w-1/2 w-full flex flex-col items-center justify-center text-center md:px-16 px-0 z-0 "
          ...
          <div className="w-full py-6 z-20">
            ...
            <div className="py-2 space-x-2">
              <FacebookLoginButton setModal={setModal} />
              <GoogleLoginButton setModal={setModal} />
              <button>
            ...
            <p className="text-gray-100">or use email to create account</p>
            <form
            ...
            >
              ...
              <div className="px-4 pb-2 pt-4">
                <button
                  type={togglePreference ? "button" : "submit"}
